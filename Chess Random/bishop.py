...
class Bishop():
    def __init__(self, boardPosition, tipe, m, s, color):
        ...
        self.tipe = tipe
        self.color = color
        self.detectionMessage = "Bishop " + str(self.color) + " located at " + str(self.boardPosition[0]) + "," + str(self.boardPosition[1])
    ...
    def checkForPiece(self):
        if pyautogui.locateCenterOnScreen("bishop_" + str(self.color) + ".png", region=(self.cornerPosition[0], self.cornerPosition[1], 95,95), confidence=0.6, grayscale=True) == None:
            print("Can't find bishop " + str(self.color) + " located at " + str(self.boardPosition[0]) + "," + str(self.boardPosition[1]))
            return False
        else:
    ...
    def determineCapture(self, pieceList):
        for piece in pieceList:
            if piece.boardPosition == self.boardPosition:
                ...
                print("Bishop " + str(self.color) + " captured!")
    ...
    def getValidMoves(self, playerPiecePositions, enemyPiecePositions):
        validMoves = []
        #Upper-Left
        move1AttemptPos = self.outOfBounds((self.boardPosition[0] - 1), (self.boardPosition[1] + 1))
        move2AttemptPos = self.outOfBounds((self.boardPosition[0] - 2), (self.boardPosition[1] + 2))
        move3AttemptPos = self.outOfBounds((self.boardPosition[0] - 3), (self.boardPosition[1] + 3))
        move4AttemptPos = self.outOfBounds((self.boardPosition[0] - 4), (self.boardPosition[1] + 4))
        move5AttemptPos = self.outOfBounds((self.boardPosition[0] - 5), (self.boardPosition[1] + 5))
        move6AttemptPos = self.outOfBounds((self.boardPosition[0] - 6), (self.boardPosition[1] + 6))
        move7AttemptPos = self.outOfBounds((self.boardPosition[0] - 7), (self.boardPosition[1] + 7))
        #Upper-Right
        move8AttemptPos = self.outOfBounds((self.boardPosition[0] + 1), (self.boardPosition[1] + 1))
        move9AttemptPos = self.outOfBounds((self.boardPosition[0] + 2), (self.boardPosition[1] + 2))
        move10AttemptPos = self.outOfBounds((self.boardPosition[0] + 3), (self.boardPosition[1] + 3))
        move11AttemptPos = self.outOfBounds((self.boardPosition[0] + 4), (self.boardPosition[1] + 4))
        move12AttemptPos = self.outOfBounds((self.boardPosition[0] + 5), (self.boardPosition[1] + 5))
        move13AttemptPos = self.outOfBounds((self.boardPosition[0] + 6), (self.boardPosition[1] + 6))
        move14AttemptPos = self.outOfBounds((self.boardPosition[0] + 7), (self.boardPosition[1] + 7))
        #Down-Left
        move15AttemptPos = self.outOfBounds((self.boardPosition[0] - 1), (self.boardPosition[1] - 1))
        move16AttemptPos = self.outOfBounds((self.boardPosition[0] - 2), (self.boardPosition[1] - 2))
        move17AttemptPos = self.outOfBounds((self.boardPosition[0] - 3), (self.boardPosition[1] - 3))
        move18AttemptPos = self.outOfBounds((self.boardPosition[0] - 4), (self.boardPosition[1] - 4))
        move19AttemptPos = self.outOfBounds((self.boardPosition[0] - 5), (self.boardPosition[1] - 5))
        move20AttemptPos = self.outOfBounds((self.boardPosition[0] - 6), (self.boardPosition[1] - 6))
        move21AttemptPos = self.outOfBounds((self.boardPosition[0] - 7), (self.boardPosition[1] - 7))
        #Down-Right
        move22AttemptPos = self.outOfBounds((self.boardPosition[0] + 1), (self.boardPosition[1] - 1))
        move23AttemptPos = self.outOfBounds((self.boardPosition[0] + 2), (self.boardPosition[1] - 2))
        move24AttemptPos = self.outOfBounds((self.boardPosition[0] + 3), (self.boardPosition[1] - 3))
        move25AttemptPos = self.outOfBounds((self.boardPosition[0] + 4), (self.boardPosition[1] - 4))
        move26AttemptPos = self.outOfBounds((self.boardPosition[0] + 5), (self.boardPosition[1] - 5))
        move27AttemptPos = self.outOfBounds((self.boardPosition[0] + 6), (self.boardPosition[1] - 6))
        move28AttemptPos = self.outOfBounds((self.boardPosition[0] + 7), (self.boardPosition[1] - 7))
    ...
    def enemyFind(self, playerPiecePositions, enemyPiecePositions, playerPieceList):
        ...
        for pos in validMoves:
            if pos == 1:
                ...
                if pyautogui.locateCenterOnScreen("bishop_" + str(self.color) + ".png", region=(checkCorner[0], checkCorner[1], 95,95), confidence=0.6, grayscale=True) == None:
                    pass
                else:
