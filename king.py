...
class King():
    def __init__(self, boardPosition, tipe, m, s, color):
        ...
        self.tipe = tipe
        self.color = color
        self.detectionMessage = "King " + str(self.color) + " located at " + str(self.boardPosition[0]) + "," + str(self.boardPosition[1])
    ...
    def checkForPiece(self):
        if pyautogui.locateCenterOnScreen("king_" + str(self.color) + ".png", region=(self.cornerPosition[0], self.cornerPosition[1], 95,95), confidence=0.6, grayscale=True) == None:
            print("Can't find king " + str(self.color) + " located at " + str(self.boardPosition[0]) + "," + str(self.boardPosition[1]))
            return False
        else:
    ...
    def determineCapture(self, pieceList):
        for piece in pieceList:
            if piece.boardPosition == self.boardPosition:
                ...
                print("King " + str(self.color) + " captured!")

    def move1(self, enemyPieceList): #Move left
    ...
    def move2(self, enemyPieceList): #Move left up
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[0] = self.boardPosition[0] - 1
    ...
    def move3(self, enemyPieceList): #Move left down
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[0] = self.boardPosition[0] - 1
        self.boardPosition[1] = self.boardPosition[1] - 1
    ...
    def move4(self, enemyPieceList): #Move down
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[1] = self.boardPosition[1] - 1
        self.updatePositions()
    ...
    def move5(self, enemyPieceList): #Move right up
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[0] = self.boardPosition[0] + 1
        self.boardPosition[1] = self.boardPosition[1] + 1
    ...
    def move6(self, enemyPieceList): #Move up
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[1] = self.boardPosition[1] + 1
        self.updatePositions()
    ...
    def move7(self, enemyPieceList): #Move right
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[0] = self.boardPosition[0] + 1
        self.updatePositions()
    ...
    def move8(self, enemyPieceList): #Move right down
        pyautogui.moveTo(self.mousePosition)
        click()
        self.boardPosition[0] = self.boardPosition[0] + 1
        self.boardPosition[1] = self.boardPosition[1] - 1
    ...
    def getValidMoves(self, playerPiecePositions):
        ...
        move2AttemptPos = self.outOfBounds((self.boardPosition[0] - 1), (self.boardPosition[1] + 1))
        move3AttemptPos = self.outOfBounds((self.boardPosition[0] - 1), (self.boardPosition[1] - 1))
        move4AttemptPos = self.outOfBounds((self.boardPosition[0]), (self.boardPosition[1] - 1))
        move5AttemptPos = self.outOfBounds((self.boardPosition[0] + 1), (self.boardPosition[1] + 1))
        move6AttemptPos = self.outOfBounds((self.boardPosition[0]), (self.boardPosition[1] + 1))
        move7AttemptPos = self.outOfBounds((self.boardPosition[0] + 1), (self.boardPosition[1]))
    ...
    def enemyFind(self, playerPiecePositions, enemyPiecePositions, playerPieceList):
        ...
        for pos in validMoves:
            if pos == 1:
                ...
                if pyautogui.locateCenterOnScreen("king_" + str(self.color) + ".png", region=(checkCorner[0], checkCorner[1], 95,95), confidence=0.6, grayscale=True) == None:
                    pass
                else:
